    ...
    <div class="page">
                        ...
                        <div class="navbar-cell">
                            <div class="navbar-panel">
                                ...
                                <div class="navbar-logo"><a class="navbar-logo-link" href="index.html"><img
                                            class="navbar-logo-default" src="images/logo-inverse-296x104.png"
                                            alt="Calm" width="148" height="52" /><img
                                            class="navbar-logo-inverse" src="images/logo-inverse-296x104.png"
                                            alt="Calm" width="148" height="52" /></a></div>
                            </div>
                        </div>
                                ...
                                <div class="navbar-subpanel-item">
                                    ...
                                    <div class="navbar-list">
                                        <div class="navbar-list-icon mdi-cellphone"></div><a
                                            class="link link-inherit navbar-list-link" href="tel:#">(+233)
                                            547255990</a>
                                    </div>
                                </div>
                                <div class="navbar-subpanel-item">
                                        ...
                                        <ul class="list list-divided">
                                            <li class="list-item">
                                                ...
                                                <div class="blurb blurb-link">
                                                    ...
                                                    <h4 class="blurb-title"><a href="donations.html">Make a
                                                            Donation</a></h4>
                                                </div>
                                            </li>
                                            <li class="list-item">
            ...
            <div class="container">
                <div class="row row-40 row-xl-55 row-xxl-100">
                    <div class="col-sm-6 col-lg-4">
                        <!-- Thumbnail-->
                        <div class="thumbnail thumbnail-simple"><a class="thumbnail-media"
                                href="single-sermon.html"><img src="images/image-3-370x266.jpg" alt=""
                                    width="370" height="266" /></a>
                            <div class="thumbnail-body">
                                <h3 class="thumbnail-title"><a href="single-sermon.html">Character</a></h3>
                                <div class="thumbnail-text">At vero eos et accusamus et iusto odio dignissimos ducimus
                                    qui blanditiis.</div><a class="thumbnail-link"
                                    href="single-sermon.html">Explore</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <!-- Thumbnail-->
                        <div class="thumbnail thumbnail-simple"><a class="thumbnail-media"
                                href="single-sermon.html"><img src="images/image-4-370x266.jpg" alt=""
                                    width="370" height="266" /></a>
                            <div class="thumbnail-body">
                                <h3 class="thumbnail-title"><a href="single-sermon.html">Christian Life</a></h3>
                                <div class="thumbnail-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                    sed do eiusmod tempo.</div><a class="thumbnail-link"
                                    href="single-sermon.html">Explore</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <!-- Thumbnail-->
                        <div class="thumbnail thumbnail-simple"><a class="thumbnail-media"
                                href="single-sermon.html"><img src="images/image-2-370x266.jpg" alt=""
                                    width="370" height="266" /></a>
                            <div class="thumbnail-body">
                                <h3 class="thumbnail-title"><a href="single-sermon.html">Healing</a></h3>
                                <div class="thumbnail-text">Ut enim ad minim veniam, quis nostrud exercitation ullamco
                                    laboris nisi ut.</div><a class="thumbnail-link"
                                    href="single-sermon.html">Explore</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <!-- Thumbnail-->
                        <div class="thumbnail thumbnail-simple"><a class="thumbnail-media"
                                href="single-sermon.html"><img src="images/image-5-370x266.jpg" alt=""
                                    width="370" height="266" /></a>
                            <div class="thumbnail-body">
                                <h3 class="thumbnail-title"><a href="single-sermon.html">Holy Spirit</a></h3>
                                <div class="thumbnail-text">Duis aute irure dolor in reprehenderit in voluptate velit
                                    esse cillum dolore eu.</div><a class="thumbnail-link"
                                    href="single-sermon.html">Explore</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <!-- Thumbnail-->
                        <div class="thumbnail thumbnail-simple"><a class="thumbnail-media"
                                href="single-sermon.html"><img src="images/image-6-370x266.jpg" alt=""
                                    width="370" height="266" /></a>
                            <div class="thumbnail-body">
                                <h3 class="thumbnail-title"><a href="single-sermon.html">Ministry</a></h3>
                                <div class="thumbnail-text">Excepteur sint occaecat cupidatat non proident, sunt in
                                    culpa qui officia.</div><a class="thumbnail-link"
                                    href="single-sermon.html">Explore</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <!-- Thumbnail-->
                        <div class="thumbnail thumbnail-simple"><a class="thumbnail-media"
                                href="single-sermon.html"><img src="images/image-7-370x266.jpg" alt=""
                                    width="370" height="266" /></a>
                            <div class="thumbnail-body">
                                <h3 class="thumbnail-title"><a href="single-sermon.html">Marriage</a></h3>
                                <div class="thumbnail-text">Sed ut perspiciatis unde omnis iste natus error sit
                                    voluptatem accusantium.</div><a class="thumbnail-link"
                                    href="single-sermon.html">Explore</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row row-30 justify-content-xl-between">
                    <div class="col-md-6 col-xl-5 text-center text-md-left" data-animate='{"class":"fadeInLeftBig"}'>
                        <div class="image-block"><img src="images/image-11-357x494.jpg" alt=""
                                width="357" height="494" />
                    ...
                    <div class="col-md-6 col-xl-7 col-xxl-6">
                        ...
                        <p class="big" data-animate='{"class":"fadeInRightBig","delay":".1"}'>Lorem ipsum dolor sit
                        ...
                        <form class="rd-mailform rd-form" data-form-output="form-consultation"
                            data-form-type="contact" method="post" action="components/rd-mailform/rd-mailform.php"
                                ...
                                <div class="col-sm-6 col-md-12 col-lg-6">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="phone"
                                            placeholder="Your Phone*" data-constraints="@PhoneNumber @Required">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-12 col-lg-6">
        ...
        <footer class="footer-contact context-dark bg-900 text-center">
            <div class="container">
                ...
                <div class="footer-row">
                    <h4>Call us 24\7</h4><a class="link link-large" href="tel:#">(+233) 547255990</a>
