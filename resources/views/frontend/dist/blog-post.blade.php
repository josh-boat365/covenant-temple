        ...
        <section class="section-md bg-transparent">
            <div class="container">
                <div class="row row-40 justify-content-xxl-between">
                    <div class="col-md-8">
                        <div class="blog-post">
                            <div class="blog-post-item"><img src="images/image-14-769x431.jpg" alt=""
                                    width="769" height="431" />
                                ...
                                <div class="post-meta list list-inline-divided text-small">
                                    ...
                                    <div class="list-item"><a class="post-date" href="#">April 10, 2021</a>
                                    </div>
                                    <div class="list-item"><a class="post-comments" href="#">0 comments</a>
                                    </div>
                                </div>
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod
                                    tempor. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
                                    ad minim veniam sed do eiusmod tempor. Sed do eiusmod tempor incididunt ut labore et
                                    dolore magna aliqua.</p><img src="images/image-20-768x431.jpg" alt=""
                                ...
                                <div class="quote quote-default quote-default-light quote-default-light">
                                    ...
                                    <div class="quote-body">
                                        <q class="quote-text h3">Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit, sed do eiusmod ut enim ad minim veniam sed.</q>
                                        <cite class="quote-cite">James Adams, Parishioner</cite>
                                    </div>
                                </div>
                                <div class="row row-15">
                                    <div class="col-sm-6"><img src="images/image-1-349x358.jpg" alt=""
                                            width="349" height="358" />
                                    </div>
                                    <div class="col-sm-6">
                                        <h3>Moving Toward Peace</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adiscing elit, sed do eiusmod tempor.
                                        </p>
                                        <p>Ut enim ad minim veniam sed do eiusmod tempor. Sed do eiusmod tempor
                                            incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do
                                            eiusmod tempor.</p>
                                ...
                                <div class="row row-15 justify-content-between align-items-center">
                                    <div class="col-sm-6">
                                        <div class="group-10"><a class="tag tag-outline" href="#">News</a><a
                                                class="tag tag-outline" href="#">Blog</a><a
                                                class="tag tag-outline" href="#">Religion</a></div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-xs-11 col-sm-6">
                                        ...
                                        <div class="post post-line">
                                            <div class="post-tags text-small"><a class="post-tag"
                                                    href="classic-blog.html">News</a>
                                            </div><a class="post-media" href="blog-post.html"><img
                                                    src="images/image-18-368x228.jpg" alt="" width="368"
                                                    height="228" />
                                                <div class="post-hover-btn mdi-link-variant"></div>
                                            </a>
                                            <div class="post-content">
                                                <h4 class="post-title"><a href="blog-post.html">The Next 10 Years: The
                                                        Context of Theology</a></h4>
                                    ...
                                    <div class="col-xs-11 col-sm-6">
                                        ...
                                        <div class="post post-line">
                                            <div class="post-tags text-small"><a class="post-tag"
                                                    ...
                                                    src="images/image-15-368x228.jpg" alt="" width="368"
                                                    height="228" />
                                                <div class="post-hover-btn mdi-link-variant"></div>
                                            </a>
                                            <div class="post-content">
                                                <h4 class="post-title"><a href="blog-post.html">Why Do Christians Need
                                                        to Hear the Gospel Every Day?</a></h4>
                                                <div class="post-date text-small">November 12, 2021</div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="blog-post-item">
                                ...
                                <form class="rd-form rd-mailform" data-form-output="form-post"
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="post post-small"><a class="post-img-link" href="blog-post.html"><img
                                            src="images/image-16-72x72.jpg" alt="" width="72"
                                            height="72" /></a>
                                    <div class="post-body">
                                        <h5 class="post-title"><a href="blog-post.html">The Context of Theology</a>
                                        </h5>
                                ...
                                <!-- Post small-->
                                <div class="post post-small"><a class="post-img-link" href="blog-post.html"><img
                                            src="images/image-17-72x72.jpg" alt="" width="72"
                                            height="72" /></a>
                                    <div class="post-body">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div class="group-10"><a class="tag tag-outline" href="#">News</a><a
                                        ...
                                        href="#">Religion</a><a class="tag tag-outline"
                                        href="#">Christianity</a><a class="tag tag-outline"
                                        href="#">Sermons</a></div>
                            </div>
                        </div>
                    </div>
