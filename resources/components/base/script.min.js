...
components.link = {
    selector: '.link',
    styles: ['./components/link/link.css', './components/mdi/mdi.css']
};
components.fontLato = {
    selector: 'html',
    styles: 'https://fonts.googleapis.com/css?family=Lato:400,500,700&display=swap'
};
...
components.person = {
    selector: '.person',
    styles: ['./components/person/person.css', './components/mdi/mdi.css']
};
components.thumbnail = {
    selector: '.thumbnail',
    styles: ['./components/thumbnail/thumbnail.css', './components/mdi/mdi.css']
};
components.input = {
...
components.progressCircle = {
    ...
    script: ['./components/util/util.min.js', './components/counter/counter.min.js', './components/progress-circle/progress-circle.min.js'],
    init: function init(nodes) {
        var observer = new IntersectionObserver(function(entries) {
            var observer = this;
            entries.forEach(function(entry) {
...
components.countdown = {
    ...
    script: ['./components/util/util.min.js', './components/progress-circle/progress-circle.min.js', './components/countdown/countdown.min.js'],
    init: function init(nodes) {
        nodes.forEach(function(node) {
...
components.owl = {
    ...
    styles: ['./components/owl-carousel/owl.carousel.css', './components/mdi/mdi.css'],
    script: ['./components/jquery/jquery-3.4.1.min.js', './components/owl-carousel/owl.carousel.min.js', './components/util/util.min.js'],
    init: function init(nodes) {
        nodes.forEach(function(node) {
...
components.regula = {
    ...
    script: ['./components/jquery/jquery-3.4.1.min.js', './components/regula/regula.min.js'],
    init: function init(nodes) {
        var elements = $(nodes);
        regula.custom({
            name: 'PhoneNumber',
...
components.rdMailform = {
    ...
    styles: ['./components/rd-mailform/rd-mailform.css', './components/font-awesome/font-awesome.css', './components/mdi/mdi.css'],
    script: ['./components/jquery/jquery-3.4.1.min.js', './components/rd-mailform/rd-mailform.min.js'],
    init: function init(nodes) {
        var i = void 0,
            j = void 0,
            k = void 0,
...
components.lightgallery = {
    ...
    script: ['./components/jquery/jquery-3.4.1.min.js', './components/lightgallery/lightgallery.min.js', './components/util/util.min.js'],
    init: function init(nodes) {
        if (!window.xMode) {
            nodes.forEach(function(node) {
                node = $(node);
...
components.spinner = {
    ...
    styles: ['./components/spinner/spinner.css', './components/mdi/mdi.css'],
...
components.nav = {
    ...
    script: ['./components/jquery/jquery-3.4.1.min.js', './components/bootstrap/js/popper.js', './components/bootstrap/js/bootstrap.min.js'],
    init: function init(nodes) {
        nodes.forEach(function(node) {
...
components.swiperDouble = {
    ...
    styles: ['./components/swiper/swiper.css', './components/animate/animate.css'],
    script: ['./components/jquery/jquery-3.4.1.min.js', './components/swiper/swiper.min.js', './components/util/util.min.js'],
    init: function init(nodes) {
        nodes.forEach(function(node) {
            ...
            var contentSlider = new Swiper(contentSliderItem, {
                effect: 'fade'
            });
                ...
                defaults = {
                    ...
                    pagination: {
                        ...
                        renderCustom: function renderCustom(swiper, current, total) {
                            var currentValue = current < 10 ? '0' + current : current,
...
components.multiswitch = {
    ...
    script: ['./components/current-device/current-device.min.js', './components/multiswitch/multiswitch.js'],
...
components.rdNavbar = {
    ...
    script: ['./components/jquery/jquery-3.4.1.min.js', './components/util/util.min.js', './components/current-device/current-device.min.js', './components/rd-navbar/rd-navbar.min.js'],
