        ...
        <section class="section-md bg-transparent">
            <div class="container">
                <div class="row row-30 row-xl-60 row-xxl-100">
                    <div class="col-md-4">
                        <!-- Post-->
                        <div class="post post-shadow"><a class="post-media" href="#"><img
                            ...
                            <div class="post-content">
                                <div class="post-tags group-5 text-small"><a class="post-tag"
                                        href="#">Sermons</a></div>
                                <h4 class="post-title text-divider"><a href="#">God’s Cure For the World’s Worst
                                        Disease</a></h4>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="post post-shadow"><a class="post-media" href="#"><img
                            ...
                            <div class="post-content">
                                <div class="post-tags group-5 text-small"><a class="post-tag"
                                        href="#">Sermons</a></div>
                                <h4 class="post-title text-divider"><a href="#">Christian Life: Running Well,
                                        Finishing Strong</a></h4>
                                <div class="post-date">November 12, 2021</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="post post-shadow"><a class="post-media" href="#"><img
                            ...
                            <div class="post-content">
                                <div class="post-tags group-5 text-small"><a class="post-tag"
                                        href="#">Sermons</a></div>
                                <h4 class="post-title text-divider"><a href="#">The Passing of Religious
                                        Opportunity</a></h4>
                                <div class="post-date">November 12, 2021</div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <!-- Post-->
                        <div class="post post-shadow"><a class="post-media" href="#"><img
                                    src="images/image-19-370x257.jpg" alt="" width="370"
                                    height="257" />
                                <div class="post-hover-btn">View</div>
                            </a>
                            <div class="post-content">
                                <div class="post-tags group-5 text-small"><a class="post-tag"
                                        href="#">Sermons</a></div>
                                <h4 class="post-title text-divider"><a href="#">Christian Life: Where Are My
                                        Strengths? (Romans 12:1-8)</a></h4>
                                <div class="post-date">November 12, 2021</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <!-- Post-->
                        <div class="post post-shadow"><a class="post-media" href="#"><img
                                    src="images/image-20-370x257.jpg" alt="" width="370"
                                    height="257" />
                                <div class="post-hover-btn">View</div>
                            </a>
                            <div class="post-content">
                                <div class="post-tags group-5 text-small"><a class="post-tag"
                                        href="#">Sermons</a></div>
                                <h4 class="post-title text-divider"><a href="#">Life is what Happens to You
                                        While You Are Making Plans</a></h4>
                                <div class="post-date">November 12, 2021</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <!-- Post-->
                        <div class="post post-shadow"><a class="post-media" href="#"><img
                                    src="images/image-5-370x257.jpg" alt="" width="370" height="257" />
                                <div class="post-hover-btn">View</div>
                            </a>
                            <div class="post-content">
                                <div class="post-tags group-5 text-small"><a class="post-tag"
                                        href="#">Sermons</a></div>
                                <h4 class="post-title text-divider"><a href="#">Rock Solid: How to Build a Life
                                        that Lasts</a></h4>
                                <div class="post-date">November 12, 2021</div>
                            </div>
                        </div>
