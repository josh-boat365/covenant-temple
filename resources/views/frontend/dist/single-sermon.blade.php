            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-xl-8">
                        <h2 class="page-title-text">Single Sermon</h2>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-md bg-transparent">
            <div class="container">
                <div class="row row-30 row-xl-55 row-xxl-100 justify-content-between">
                    <div class="col-md-8"><img src="images/image-12-769x431.jpg" alt="" width="769"
                            height="431" />
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod tempor. Sed do eiusmod
                            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod
                            tempor. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <div class="row row-25 row-offset-md">
                            <div class="col-sm-6"><img src="images/image-13-349x373.jpg" alt=""
                                    width="349" height="373" />
                            </div>
                            <div class="col-sm-6">
                                <h3 class="h3-big">Promptness</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
                                <p>Ut enim ad minim veniam sed do eiusmod tempor. Sed do eiusmod tempor incididunt ut
                                    labore et dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod tempor.</p>
                ...
                <div class="owl-carousel owl-quote" data-owl="{&quot;dots&quot;:true}" data-items="1">
                    ...
                    <div class="quote quote-large">
                        ...
                        <div class="quote-body">
                            <q class="quote-text h3 h3-big">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</q>
                            <div class="quote-person"><img class="quote-img" src="images/person/person-9-53x53.jpg"
                    ...
                    <div class="quote quote-large">
                        ...
                        <div class="quote-body">
                            <q class="quote-text h3 h3-big">Tempor orci dapibus ultrices in iaculis nunc sed augue
                                lacus. Sed sed risus pretium quam vulputate dignissim suspendisse in. Scelerisque.</q>
                            <div class="quote-person"><img class="quote-img" src="images/person/person-5-53x53.jpg"
                                    alt="" width="53" height="53" />
                    ...
                    <div class="quote quote-large">
                        ...
                        <div class="quote-body">
                            <q class="quote-text h3 h3-big">Scelerisque viverra mauris in aliquam sem fringilla.
                                Elementum curabitur vitae nunc sed velit. Sit amet consectetur adipiscing elit. Ac
                                turp.</q>
                            <div class="quote-person"><img class="quote-img" src="images/person/person-10-53x53.jpg"
                                    alt="" width="53" height="53" />
