            ...
            <div class="container">
                <div class="row row-30 justify-content-center justify-content-sm-between">
                    <div class="col-8 col-8 col-md-6 col-lg-5 text-center text-md-left">
                        <div class="image-block"><img src="images/person/person-7-469x565.jpg" alt=""
                                width="469" height="565" />
                            <div class="image-block-embed">
                                <!-- Counter-->
                                <div class="counter">
                                    <div class="counter-value"><span data-counter="">85</span><span
                                            class="counter-unit"></span>
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="group-5 d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <ul class="list list-inline">
                                <li class="list-inline-item"><a class="icon icon-md icon-link-gray mdi mdi-facebook"
                                        href="#"></a></li>
                                <li class="list-inline-item"><a
                                        class="icon icon-md icon-link-gray mdi mdi-youtube-play" href="#"></a>
                                </li>
                                <li class="list-inline-item"><a class="icon icon-md icon-link-gray mdi mdi-twitter"
                                        href="#"></a></li>
                            </ul>
                        </div>
                        ...
                        <div class="address">
                            <table>
                                <tr>
                                    ...
                                    <td class="big"><a class="link link-inherit" href="tel:#">(+233)
                                            547255990</a></td>
                                </tr>
                                <tr>
                    ...
                    <div class="col-md-6">
                        <div class="text-block-2">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                                ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod tempor.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="text-block-2">
                            <div class="text-small text-primary text-divider text-divider-wide">10+ years of experience
                            </div>
                    ...
                    <div class="col-md-11">
                        ...
                        <div class="quote quote-default quote-default-light quote-default-light">
                            ...
                            <div class="quote-body">
                                <q class="quote-text h3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                                    do eiusmod ut enim ad minim veniam sed do eiusmod tempor incididunt ut labore et
                ...
                <div class="row row-30 justify-content-between">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="progress-linear">
                            <div class="progress-linear-title h4">Public Speaking<span
                                    class="progress-linear-counter-wrap"><span
                        ...
                        <!-- Linear progress bar-->
                        <div class="progress-linear">
                            <div class="progress-linear-title h4">Spiritual Growth<span
                                    class="progress-linear-counter-wrap"><span
                        ...
                        <!-- Linear progress bar-->
                        <div class="progress-linear">
                            <div class="progress-linear-title h4">Counsel<span
                                    class="progress-linear-counter-wrap"><span
                        ...
                        <!-- Linear progress bar-->
                        <div class="progress-linear">
                            <div class="progress-linear-title h4">Christian Education<span
                                    class="progress-linear-counter-wrap"><span
        ...
        <section class="section-md bg-900 context-dark" id="appointment-form">
            <div class="container">
                <div class="row row-5 align-items-baseline">
                    ...
                    <div class="col-lg-6">
                        <h3 class="font-italic font-secondary" style="opacity: .6">Excellent legal assistance without
                            stress</h3>
                    </div>
                </div>
