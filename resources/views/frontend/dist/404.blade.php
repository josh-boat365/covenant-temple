            ...
            <div class="container">
                <div class="row row-30 row-lg-5 row-gutters-5">
                    <div class="col-sm-6 col-lg-8">
                        ...
                        <p class="big">We are sorry but the page you were looking for couldn’t be found. It could
                            have also been renamed or deleted. Use our search below or go to homepage to find out more.
                        </p>
                    </div>
                    ...
                    <div class="col-sm-11">
                        <div class="rd-serch-container bg-100">
                            <div class="d-flex align-items-center group-20 flex-wrap justify-content-center">
                                ...
                                <div class="rd-serch-container-item"><a class="btn" href="index.html">Go Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
