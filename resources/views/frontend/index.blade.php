...
<body>
    <div class="page">
        ...
        <section class="intro intro-line context-dark">
                        ...
                        <div class="intro-line-col">
                            <div class="navbar-cell">
                                <div class="navbar-panel">
                                    ...
                                    <div class="navbar-logo"><a class="navbar-logo-link" href="index.html"><img class="navbar-logo-default" src="{{ asset('images/tcc-logo-2.png')}}" /><img class="navbar-logo-inverse" src="{{ asset('images/tcc-logo-2.png')}}" alt="Calm" /></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="intro-line-col intro-line-col-center">
                            <div class="navbar-cell">
                                <ul class="navbar-navigation rd-navbar-nav">
                                    ...
                                    <li class="navbar-navigation-root-item navbar-navigation-item-hidden"><a class="navbar-navigation-root-link" href="sermons.html">Events</a>
                                    </li>

                                    <li class="navbar-navigation-root-item navbar-navigation-item-hidden"><a class="navbar-navigation-root-link" href="sermons.html">Gallery</a>
                                    </li>

                                    <li class="navbar-navigation-root-item navbar-navigation-item-hidden"><a class="navbar-navigation-root-link" href="sermons.html">Donations</a>
                                    </li>

                                    <li class="navbar-navigation-root-item navbar-navigation-item-hidden"><a class="navbar-navigation-root-link" href="{{ route('contact-us') }}">Contact us</a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="navbar-subpanel">
                                    <div class="navbar-subpanel-item">
                                        ...
                                        <div class="navbar-list">
                                            <div class="navbar-list-icon mdi-cellphone"></div><a class="link link-inherit navbar-list-link" href="tel:#">(+233) 547255990</a>
                                        </div>
                                    </div>
                        ...
                        <div class="intro-line-col navbar-subpanel-contact">
                            ...
                            <div class="navbar-contact">
                                <ul class="list list-sm">
                                    <li class="list-item">
                                        <h4 class="text-uppercase text-primary" style="color: #1B5A2A !important">Our doors are always opened</h4>
                                    </li>
                                    <li class="list-item"><a class="link link-inherit-primary big2" href="tel:#">(+233) 547255990</a></li>
                                    <li class="list-item"><a class="link link-inherit-primary" href="mailto:tccpokuase@gmail.com">tccpokuase@gmail.com</a></li>
                                    <li class="list-item"><span>P.O.Box DS 2234, Dansoman</span></li>
                                    <li class="list-item"><span>Pokuase Near Ampax Hotel <br />Off Nsawam - Accra Road,<br> GW-0120-1829</span></li>
                                </ul>
                            ...
                            <div class="row row-25">
                                ...
                                <div class="col-lg-3 col-xl-5 text-center text-lg-right">
                                    <div class="group-15 group-lg-30">
                                        <a class="icon icon-md icon-link icon-link-gray mdi-facebook" href="https://www.facebook.com/tccpokuaseofficial"></a>
                                        <a class="icon icon-md icon-link icon-link-gray mdi-youtube-play" href="https://www.youtube.com/@tccpokuase"></a>
            ...
            <div class="swiper-container swiper-numbered" data-swiper>
                ...
                <div class="swiper-wrapper">
                    <!-- Slides-->
                    <div class="swiper-slide" style="background-image: url( {{asset('images/background/bg-1.jpg')}} )">
                                ...
                                <div class="row">
                                    <div class="col-md-10 col-lg-7">
                                        <div style="background-color: #0000008c; padding: 1.5rem">
                                            ...
                                            <p class="big">Calm Church is a Family of Faith that is committed to Bible teaching and joyful worship for children, youth and adults of all ages.</p>
                                        </div>
                    ...
                    <div class="swiper-slide" style="background-image: url( {{ asset('images/background/bg-2.jpg') }} )">
                        <div class="intro-line-container">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-10 col-lg-7">
                                        <div style="background-color: #0000008c; padding: 1.5rem">
                                            ...
                                            <h1>Connect & Grow</h1>
                                            <p class="big">Our church is a perfect place for all local residents to come in with their families and join for a prayer and a newfound peace of mind.</p>
                                        </div>
                                        <a class="btn btn-white" href="#">See More</a>
                                    </div>
                                </div>
                    ...
                    <div class="swiper-slide" style="background-image: url( {{ asset('images/background/bg-3.jpg') }} )">
                        <div class="intro-line-container">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-10 col-lg-7">
                                        <div style="background-color: #0000008c; padding: 1.5rem">
                                            ...
                                            <p class="big">At our church, we help people to find their way back to God. We accomplish this by reaching people far from God.</p>
                                        </div>
                                        <a class="btn btn-white" href="#">See More</a>
                                    </div>
                                </div>
            ...
            <div class="container container-wide">
                <div class="row row-40 row-xl-55 row-xxl-100 row-offset-md">
                    <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig"}'>
                        <!-- Thumbnail-->
                        <div class="thumbnail thumbnail-light"><a class="thumbnail-media" href="#"><img src="images/image-18-425x338.jpg" alt="" width="425" height="338" /></a>
                    ...
                    <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig","delay":".15s"}'>
                        <!-- Thumbnail-->
                        <div class="thumbnail thumbnail-light"><a class="thumbnail-media" href="#"><img src="images/image-12-425x338.jpg" alt="" width="425" height="338" /></a>
                    ...
                    <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig","delay":".3s"}'>
                        <!-- Thumbnail-->
                        <div class="thumbnail thumbnail-light"><a class="thumbnail-media" href="#"><img src="images/image-1-425x338.jpg" alt="" width="425" height="338" /></a>
                    ...
                    <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig","delay":".45s"}'>
                        <!-- Thumbnail-->
                        <div class="thumbnail thumbnail-light"><a class="thumbnail-media" href="#"><img src="images/image-8-425x338.jpg" alt="" width="425" height="338" /></a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-lg-9" data-animate='{"class":"fadeIn"}'>
                        <h3 class="text-decorated text-decorated-large">Our church incorporates God’s family into our fellowship. We provide a warm, authentic community, welcoming new believers into the body of Christ through baptism.</h3>
                    </div>
                </div>
            </div>
        </section>
            ...
            <section class="section-double-top">
                <div class="container">
                    <div class="layout layout-2">
                        <div class="layout-media bg-image" style="background-image: url(images/image-19-837x551.jpg)" data-animate='{"class":"fadeInUpBig"}'></div>
                        <div class="layout-content bg-100" data-animate='{"class":"fadeInUpBig","delay":".2s"}'>
                            <h2>About Church</h2>
                            <p>At Calm Church, we want the love that Christ showed on the cross to flow out of our lives, impacting the community.</p>
                            <p>We come from all different backgrounds and cultures but are united in the pursuit and worship of Christ. Above all else, we want to glorify God. We strongly believe that God does His work through the local church and that it is a vital part of the Christian life. Please join us as we come together and let the Gospel transform us!</p>
                            <div class="group-20 mt-5" data-lightgallery><a class="btn btn-primary" href="#">Donate Now</a><a class="btn btn-outline btn-icon lightgallery-item" href="https://youtu.be/hNQFjqDvPhA">
                                    <svg class="icon" width="9" height="12" viewBox="0 0 9 12" xmlns="http://www.w3.org/2000/svg">
            ...
            <section class="section-md context-dark bg-darkest section-double-bottom">
                <div class="container">
                    ...
                    <div class="row row-30 row-offset-md">
                        ...
                        <div class="col-6 col-md-3">
                            <div class="box-icon-bordered">
                                <div class="box-icon-bordered-icon text-primary linearicons-trophy2"></div>
                    ...
                    <div class="swiper-container" data-swiper='{"breakpoints":{"576":{"slidesPerView":2,"spaceBetween":15},"768":{"slidesPerView":3,"spaceBetween":30}},"loop":false,"pagination":{"type":"custom"}}'>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <!-- Post-->
                                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img src="images/image-12-370x257.jpg" alt="" width="370" height="257" />
                                        <div class="post-hover-btn">View</div>
                                    </a>
                                    <div class="post-content">
                                        <div class="post-tags group-5 text-small"><a class="post-tag" href="sermons.html">Sermons</a></div>
                                        <h4 class="post-title text-divider"><a href="blog-post.html">God’s Cure For the World’s Worst Disease</a></h4>
                            ...
                            <div class="swiper-slide">
                                <!-- Post-->
                                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img src="images/image-1-370x257.jpg" alt="" width="370" height="257" />
                                        <div class="post-hover-btn">View</div>
                                    </a>
                                    <div class="post-content">
                                        <div class="post-tags group-5 text-small"><a class="post-tag" href="sermons.html">Sermons</a></div>
                                        <h4 class="post-title text-divider"><a href="blog-post.html">Christian Life: Running Well, Finishing Strong</a></h4>
                                        <div class="post-date">November 12, 2021</div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <!-- Post-->
                                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img src="images/image-13-370x257.jpg" alt="" width="370" height="257" />
                                        <div class="post-hover-btn">View</div>
                                    </a>
                                    <div class="post-content">
                                        <div class="post-tags group-5 text-small"><a class="post-tag" href="sermons.html">Sermons</a></div>
                                        <h4 class="post-title text-divider"><a href="blog-post.html">The Passing of Religious Opportunity</a></h4>
                                        <div class="post-date">November 12, 2021</div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <!-- Post-->
                                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img src="images/image-4-370x257.jpg" alt="" width="370" height="257" />
                                        <div class="post-hover-btn">View</div>
                                    </a>
                                    <div class="post-content">
                                        <div class="post-tags group-5 text-small"><a class="post-tag" href="sermons.html">Sermons</a></div>
                                        <h4 class="post-title text-divider"><a href="blog-post.html">Christian Life: Where Are My Strengths? (Romans 12:1-8)</a></h4>
                                        <div class="post-date">November 12, 2021</div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <!-- Post-->
                                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img src="images/image-8-370x257.jpg" alt="" width="370" height="257" />
                                        <div class="post-hover-btn">View</div>
                                    </a>
                                    <div class="post-content">
                                        <div class="post-tags group-5 text-small"><a class="post-tag" href="sermons.html">Sermons</a></div>
                                        <h4 class="post-title text-divider"><a href="blog-post.html">Life is what Happens to You While You Are Making Plans</a></h4>
                                        <div class="post-date">November 12, 2021</div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <!-- Post-->
                                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img src="images/image-9-370x257.jpg" alt="" width="370" height="257" />
                                        <div class="post-hover-btn">View</div>
                                    </a>
                                    <div class="post-content">
                                        <div class="post-tags group-5 text-small"><a class="post-tag" href="sermons.html">Sermons</a></div>
                                        <h4 class="post-title text-divider"><a href="blog-post.html">Rock Solid: How to Build a Life that Lasts</a></h4>
                                        <div class="post-date">November 12, 2021</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row row-40 justify-content-between align-items-center">
                    ...
                    <div class="col-md-7 col-xl-6" data-animate='{"class":"fadeInRightBig"}'>
                        <div class="layout layout-3">
                            <div class="layout-media bg-image" style="background-image: url( images/image-16-470x600.jpg )"></div>
                            <div class="layout-content bg-900 context-dark">
                                <div class="owl-carousel owl-quote-3" data-owl="{&quot;dots&quot;:true}" data-items="1">
                                    ...
                                    <div class="quote quote-line">
                                        ...
                                        <div class="quote-person"><img class="quote-img" src="images/person/person-9-53x53.jpg" alt="" width="53" height="53" />
                                    ...
                                    <div class="quote quote-line">
                                        ...
                                        <div class="quote-person"><img class="quote-img" src="images/person/person-5-53x53.jpg" alt="" width="53" height="53" />
                                    ...
                                    <div class="quote quote-line">
                                        ...
                                        <div class="quote-person"><img class="quote-img" src="images/person/person-10-53x53.jpg" alt="" width="53" height="53" />
                ...
                <div class="row row-5 row-gutters-5 row-offset-lg person-poster-container">
                    <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig"}'>
                        <!-- Person--><a class="person person-poster" href="team-member.html">
                            <div class="person-media bg-image" style="background-image: url(images/person/Head-Pastor.png)">
                    ...
                    <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig","delay":".15s"}'>
                        <!-- Person--><a class="person person-poster" href="team-member.html">
                            <div class="person-media bg-image" style="background-image: url(images/person/Head-Pastor-1.png)">
                                <div class="person-btn mdi mdi-arrow-right"></div>
                            </div>
                            <div class="person-content">
        ...
        <div class="container">
          <div class="layout layout-2">
            <div class="layout-media bg-image" style="background-image: url(images/image-13-837x551.jpg)" data-animate='{"class":"fadeInUpBig"}'></div>
            <div class="layout-content bg-100" data-animate='{"class":"fadeInUpBig","delay":".2s"}'>
              <div class="text-block-1">
            ...
            <div class="container">
                <div class="row row-5 align-items-baseline">
                    ...
                    <div class="col-lg-6" data-animate='{"class":"fadeIn","delay":".2s"}'>
                        <h3 class="font-italic font-secondary" style="opacity: .6">Get an appointment with one of our pastors</h3>
                    </div>
                </div>
                <form class="rd-mailform rd-form" data-form-output="form-appointment" data-form-type="contact" method="post" action="components/rd-mailform/rd-mailform.php">
            ...
            <div class="container">
                <div class="footer-row">
                    <div class="footer-logo">
                        <a class="logo-link" href="index.html">
                            <img src="images/tcc-logo-2.png" alt="" style="width: 20rem;" />
                        </a>
                    </div>
                </div>
                <div class="footer-row">
                ...
                <div class="footer-row">
                    ...
                    <ul class="social social-bordered footer-social">
                        <li><a class="social-icon icon icon-md mdi-youtube-play" href="https://www.youtube.com/@tccpokuase"></a></li>
                        <li><a class="social-icon icon icon-md mdi-facebook" href="https://www.facebook.com/tccpokuaseofficial"></a></li>
                ...
                <div class="footer-row">
                    ...
                    <!-- Copyright-->
                    <p class="rights"><span>&copy; 2023&nbsp;</span><span>Triumphant Christian Center - Pokuase Branch - Covenant Temple</span><span>. All rights reserved.&nbsp;</span><a class="link link-inherit rights-link" href="privacy-policy.html">Privacy Policy</a></p>
                </div>
            </div>
        </footer>
        <!-- coded by barber-->
