        ...
        <section class="section-md bg-transparent">
            <div class="container">
                <div class="row">
                    <div class="col-lg-11">
                        <h2>Paragraphs</h2>
                        <p class="text-block"><span>Welcome to our wonderful world. </span><strong>This is a bold text
                            </strong>
                            <mark>This is a highlighted text</mark><span> We sincerely hope that each and every user
                                ...
                                features of activating account and new login </span><span
                                class="tooltip-custom text-primary"
                                data-tooltip='{"placement":"top","title":"Default text"}'>Tooltips</span><span>
                                widgets, you will definitely have a great experience of using our web page. </span><span
                                class="text-strike">This is a strikethrough text</span><span>, </span>
                            <u>This is an underlined text.</u> <a href="#">Link</a> <a class="link-active"
                                href="#">Press link</a>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="quote quote-default">
                            ...
                            <div class="quote-body">
                                <q class="quote-text h4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                                    do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
                                    veniam. sed do eiusmod tempor incididunt ut labore.</q>
