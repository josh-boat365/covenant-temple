                ...
                <div class="row row-50 justify-content-between">
                    <div class="col-md-6">
                        ...
                        <div class="group-25 mt-4 d-flex align-items-start flex-column flex-sm-row"><img
                                class="rounded-circle" src="images/person/person-6-125x125.jpg" alt=""
                    ...
                    <div class="col-md-6 col-lg-5">
                        <form class="rd-mailform rd-form" data-form-output="form-consultation"
                            ...
                            <div class="row row-15">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" type="text" name="price"
                                                placeholder="200.00" data-constraints="@Numeric">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <button class="btn" type="submit" style="width: 100%">Make a
                                        Donation</button>
                                </div>
                            </div>
                        </form>
