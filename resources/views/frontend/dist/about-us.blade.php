            ...
            <div class="container">
                <div class="row row-25 row-xl-55">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <p class="big">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed.</p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="row row-30">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="blurb blurb-icon-left">
                                ...
                                <div class="blurb-text">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut
                                    odit aut fugit, sed quia consequuntur magni dolores eos.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container"><img class="img-single" src="images/image-2-1170x386.jpg" alt=""
                    ...
                    <div class="row row-30">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <ul class="list list-divided h4">
                                <li class="list-item"><a class="link link-arrow" href="single-sermon.html">Holy
                                        Spirit</a></li>
                                <li class="list-item"><a class="link link-arrow" href="single-sermon.html">Hope</a>
                                </li>
                                <li class="list-item"><a class="link link-arrow"
                                        href="single-sermon.html">Marriage</a></li>
                            </ul>
                        </div>
                        <div class="col-sm-6 col-lg-3">
                            <ul class="list list-divided h4">
                                <li class="list-item"><a class="link link-arrow"
                                        href="single-sermon.html">Ministry</a></li>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <ul class="list list-divided h4">
                                <li class="list-item"><a class="link link-arrow"
                                        href="single-sermon.html">Revival</a></li>
                                <li class="list-item"><a class="link link-arrow"
                                        href="single-sermon.html">Salvation</a></li>
