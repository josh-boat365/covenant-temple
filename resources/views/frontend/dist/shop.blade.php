                        ...
                        <div class="row row-40 row-xl-55">
                            <div class="col-6 col-lg-4">
                                ...
                                <div class="product product-simple"><a class="product-media"
                                        href="single-product.html"><img src="images/product/product-1-270x358.jpg"
                                            alt="" width="270" height="358" /></a>
                                    <h4 class="product-title"><a href="single-product.html">Spring Harvest 2020
                                            Songbook: Unleashed</a></h4>
                            ...
                            <div class="col-6 col-lg-4">
                                <!-- Product-->
                                <div class="product product-simple"><a class="product-media"
                                        href="single-product.html"><img src="images/product/product-2-270x358.jpg"
                                            alt="" width="270" height="358" /></a>
                                    <h4 class="product-title"><a href="single-product.html">The Ruthless Elimination
                                            of Hurry</a></h4>
                                    <div class="h4 product-price">$35.00</div>
                                </div>
                            </div>
                            <div class="col-6 col-lg-4">
                                <!-- Product-->
                                <div class="product product-simple"><a class="product-media"
                                        href="single-product.html"><img src="images/product/product-3-270x358.jpg"
                                            alt="" width="270" height="358" /></a>
                                    <h4 class="product-title"><a href="single-product.html">Ten Girls Who Changed the
                                            World</a></h4>
                                    <div class="h4 product-price">$35.00</div>
                                </div>
                            </div>
                            <div class="col-6 col-lg-4">
                                <!-- Product-->
                                <div class="product product-simple"><a class="product-media"
                                        href="single-product.html"><img src="images/product/product-4-270x358.jpg"
                                            alt="" width="270" height="358" /></a>
                                    <h4 class="product-title"><a href="single-product.html">The Usborne Children's
                                            Bible</a></h4>
                                    <div class="h4 product-price">$35.00</div>
                                </div>
                            </div>
                            <div class="col-6 col-lg-4">
                                <!-- Product-->
                                <div class="product product-simple"><a class="product-media"
                                        href="single-product.html"><img src="images/product/product-5-270x358.jpg"
                                            alt="" width="270" height="358" /></a>
                                    <h4 class="product-title"><a href="single-product.html">KJV Pocket Size New
                                            Testament And Psalms</a></h4>
                                    <div class="h4 product-price">$35.00</div>
                                </div>
                            </div>
                            <div class="col-6 col-lg-4">
                                <!-- Product-->
                                <div class="product product-simple"><a class="product-media"
                                        href="single-product.html"><img src="images/product/product-6-270x358.jpg"
                                            alt="" width="270" height="358" /></a>
                                    <h4 class="product-title"><a href="single-product.html">NIV Holy Bible, Purple,
                                            Hodder Classic Design</a></h4>
                                    <div class="h4 product-price">$35.00</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget-body">
                                <form action="search-results.html" method="GET"
                                    ...
                                    <div class="form-group form-group-icon">
                                        <input class="form-control" type="text" placeholder="Search in shop..."
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <ul class="list list-divided list-divided-sm big">
                                    <li class="list-item"><a class="link link-arrow" href="#">Bibles</a></li>
                                    <li class="list-item"><a class="link link-arrow" href="#">Children’s</a>
                                    </li>
                                    <li class="list-item"><a class="link link-arrow" href="#">Christian
                                            Books</a></li>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="rd-range" data-min="0" data-max="999" data-min-diff="100"
                                    data-start="[66, 335]" data-step="1" data-tooltip="false"
                            ...
                            <div class="widget-body">
                                ...
                                <div class="product product-small"><a class="product-img-link"
                                        href="single-product.html"><img src="images/product/product-1-72x91.jpg"
                                            alt="" width="72" height="91" /></a>
                                    <div class="product-body">
                                        <h5 class="product-title"><a href="single-product.html">Spring Harvest 2020
                                                Songbook</a></h5>
                                ...
                                <!-- Product small-->
                                <div class="product product-small"><a class="product-img-link"
                                        href="single-product.html"><img src="images/product/product-3-72x91.jpg"
                                            alt="" width="72" height="91" /></a>
                                    <div class="product-body">
                                        <h5 class="product-title"><a href="single-product.html">Ten Girls Who Changed
                                                the World</a></h5>
                                        <div class="product-price">$35</div>
                                    </div>
                                </div>
