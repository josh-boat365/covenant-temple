            ...
            <div class="container">
                <div class="row row-25 row-xl-55 justify-content-between">
                    <div class="col-sm-6 col-lg-5"><img class="shadow-sm image image-sm"
                            src="images/product/product-6-510x663.jpg" alt="" width="510"
                            height="663" />
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <div class="product-overview">
                            ...
                            <p class="big">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do.</p>
                            <p class="big">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do.
            ...
            <div class="container">
                <div class="tab tab-classic">
                    <ul class="nav nav-classic tab-header" role="tablist">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#navClassic1-1"
                                role="tab" aria-selected="true">Description</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#navClassic1-2"
                                role="tab" aria-selected="false">Reviews (0)</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="navClassic1-1" role="tabpanel">
                            <h3>Product Overview</h3>
                            <p class="big">Ut enim ad minim veniam sed do eiusmod tempor .Lorem ipsum dolor sit
                                amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                                magna aliqua. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
                                ad minim veniam sed do eiusmod tempor.</p>
                            <p class="big">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do.
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod
                                tempor. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                                minim veniam sed do eiusmod tempor.</p>
                        </div>
                ...
                <div class="row row-40 row-xl-55">
                    <div class="col-6 col-lg-3">
                        ...
                        <div class="product product-simple"><a class="product-media" href="single-product.html"><img
                                    src="images/product/product-1-270x358.jpg" alt="" width="270"
                                    height="358" /></a>
                            <h4 class="product-title"><a href="single-product.html">The Usborne Children's Bible</a>
                            </h4>
                    ...
                    <div class="col-6 col-lg-3">
                        <!-- Product-->
                        <div class="product product-simple"><a class="product-media" href="single-product.html"><img
                                    src="images/product/product-2-270x358.jpg" alt="" width="270"
                                    height="358" /></a>
                            <h4 class="product-title"><a href="single-product.html">The Ruthless Elimination of
                                    Hurry</a></h4>
                            <div class="h4 product-price">$35.00</div>
                        </div>
                    </div>
                    <div class="col-6 col-lg-3">
                        <!-- Product-->
                        <div class="product product-simple"><a class="product-media" href="single-product.html"><img
                                    src="images/product/product-4-270x358.jpg" alt="" width="270"
                                    height="358" /></a>
                    ...
                    <div class="col-6 col-lg-3">
                        <!-- Product-->
                        <div class="product product-simple"><a class="product-media" href="single-product.html"><img
                                    src="images/product/product-3-270x358.jpg" alt="" width="270"
                                    height="358" /></a>
